    ...
    return (
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {Array.from({ length: count }).map((_, i) => (
                <div key={i} className="flex flex-col justify-between p-6 rounded-xl bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 shadow animate-pulse" >
