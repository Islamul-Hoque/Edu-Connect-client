            ...
            <div className="mx-auto bg-white shadow-lg rounded-lg p-8">
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={handleSubmit(handleUpdateTuition)}>
                    <div>
                        ...
                        <input type="text" {...register("subject", { required: true })} className="inputField" placeholder="Enter subject" />
                        {errors.subject && <p className="text-red-500">Subject is required.</p>}
                    </div>
                    <div>
                        <label className="label">Class</label>
                        <input type="text" {...register("class", { required: true })} className="inputField" placeholder="Enter class" />
                        {errors.class && <p className="text-red-500">Class is required.</p>}
                    </div>
                    <div>
                        <label className="label">Medium</label>
                        <input type="text" {...register("medium", { required: true })} className="inputField" placeholder="Enter medium" />
                        {errors.medium && <p className="text-red-500">Medium is required.</p>}
                    </div>
                    <div>
                        <label className="label">Institution</label>
                        <input type="text" {...register("institution", { required: true })} className="inputField" placeholder="Enter institution" />
                        {errors.institution && <p className="text-red-500">Institution is required.</p>}
                    </div>
                    <div>
                        <label className="label">Location</label>
                        <input type="text" {...register("location", { required: true })} className="inputField" placeholder="Enter location" />
                        {errors.location && <p className="text-red-500">Location is required.</p>}
                    </div>
                    <div>
                        <label className="label">Schedule</label>
                        <input type="text" {...register("schedule", { required: true })} className="inputField" placeholder="Enter schedule" />
                        {errors.schedule && <p className="text-red-500">Schedule is required.</p>}
                    </div>
                    <div>
                        <label className="label">Duration</label>
                        <input type="text" {...register("duration", { required: true })} className="inputField" placeholder="Enter duration" />
                        {errors.duration && <p className="text-red-500">Duration is required.</p>}
                    </div>
                    <div>
                        <label className="label">Days per Week</label>
                        <input type="number" {...register("daysPerWeek", { required: true })} className="inputField" placeholder="Enter days per week" />
                        {errors.daysPerWeek && <p className="text-red-500">Days per week is required.</p>}
                    </div>
                    <div>
                        <label className="label">Budget</label>
                        <input type="number" {...register("budget", { required: true })} className="inputField" placeholder="Enter budget" />
                        {errors.budget && <p className="text-red-500">Budget is required.</p>}
                    </div>
                    <div>
                        <label className="label">Phone Number</label>
                        <input type="text" {...register("phone", { required: true })} className="inputField" placeholder="Enter phone number" />
                        {errors.phone && <p className="text-red-500">Phone number is required.</p>}
                    </div>
                    <div className="md:col-span-2">
                        <label className="label">Additional Requirements</label>
                        <textarea {...register("additionalRequirements", { required: true })} className="textarea inputField" placeholder="Enter requirements" />
