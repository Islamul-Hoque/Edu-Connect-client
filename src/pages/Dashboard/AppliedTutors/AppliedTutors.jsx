...
const AppliedTutors = () => {
  ...
  if (result.isConfirmed) {
    const res = await axiosSecure.patch(`/applications/student/${applicationId}`, { status: "Rejected" });
          ...
          <tbody>
            {applications.map((app, index) => (
              <tr key={app._id} className="dark:text-gray-50">
                ...
                <td>
                  <span className="font-semibold">Subject: {app.tuitionInfo.subject}</span> <br />
