...
const AddTuition = () => {
  ...
  return (
    <div className="px-6 md:px-10 py-6 md:py-10 ">
      <div className="SectionCard mx-auto  shadow-lg rounded-lg p-8">
      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={handleSubmit(handleAddTuition)}>
        <div>
          ...
          <input type="text" {...register("subject", { required: true })} className="inputField inputFieldDark" placeholder="Enter subject (e.g. Mathematics)" />
          {errors.subject && <p className="text-red-500">Subject is required.</p>}
        </div>

        <div>
          <label className="label dark:text-gray-50">Class</label>
          <input type="text" {...register("class", { required: true })} className="inputField inputFieldDark" placeholder="Enter class (e.g. Class 9)" />
          {errors.class && <p className="text-red-500">Class is required.</p>}
        </div>

        <div>
          <label className="label dark:text-gray-50">Medium</label>
          <input type="text" {...register("medium", { required: true })} className="inputField inputFieldDark" placeholder="Enter medium (e.g. English Version)" />
          {errors.medium && <p className="text-red-500">Medium is required.</p>}
        </div>

        <div>
          <label className="label dark:text-gray-50">Institution</label>
          <input type="text" {...register("institution", { required: true })} className="inputField inputFieldDark" placeholder="Enter institution name" />
        ...
        <div>
          ...
          <input type="text" {...register("location", { required: true })} className="inputField inputFieldDark" placeholder="Enter city (e.g. Chittagong City)" />
          {errors.location && <p className="text-red-500">Location is required.</p>}
        </div>

        <div>
          <label className="label dark:text-gray-50">Schedule</label>
          <input type="text" {...register("schedule", { required: true })} className="inputField inputFieldDark" placeholder="Sat-Mon-Wed, 5PM-7PM" />
          {errors.schedule && <p className="text-red-500">Schedule is required.</p>}
        </div>

        <div>
          <label className="label dark:text-gray-50">Duration</label>
          <input type="text" {...register("duration", { required: true })} className="inputField inputFieldDark" placeholder="2 hours per session" />
        ...
        <div>
          ...
          <input type="number" {...register("daysPerWeek", { required: true })} className="inputField inputFieldDark" placeholder="Enter number of days per week" />
        ...
        <div>
          ...
          <input type="text" {...register("phone", { required: true })} className="inputField inputFieldDark" placeholder="Enter your phone number" />
          {errors.phone && <p className="text-red-500">Phone number is required.</p>}
        </div>

        <div className="md:col-span-2">
          <label className="label dark:text-gray-50 ">Additional Requirements</label>
          <textarea {...register("additionalRequirements", {required: true})} className="textarea inputField inputFieldDark" placeholder="Enter any additional requirements" />
          {errors.additionalRequirements && <p className="text-red-500">Additional requirements are required.</p>}
        </div>

        <div>
          <label className="label dark:text-gray-50 ">Student Name</label>
          <input type="text" value={user?.displayName} readOnly className="inputField inputFieldDark" />
        </div>
        <div>
          <label className="label dark:text-gray-50 ">Student Email</label>
          <input type="email" value={user?.email || user?.providerData?.[0]?.email} readOnly className="inputField inputFieldDark" />
        </div>
