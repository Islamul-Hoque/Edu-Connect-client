...
const ErrorPage = () => {
    return (
        <motion.div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 text-center p-6" initial="hidden" animate="visible" variants={containerVariants}>
