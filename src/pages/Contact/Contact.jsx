...
const Contact = () => {
    const { user } = useAuth();
    return (
        <div className=" px-6 md:px-10 py-6 md:py-10 bg-linear-to-br from-indigo-50 via-purple-50/0.1 to-white bg-dark ">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    <motion.div className="bg-white dark:dark:bg-gray-800 p-8 rounded-xl shadow-lg" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={staggerContainer}>
                    ...
                    <motion.form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg space-y-6" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeInUp}>
