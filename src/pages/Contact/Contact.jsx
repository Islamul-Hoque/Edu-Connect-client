            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    <motion.div className="bg-white dark:dark:bg-gray-900 p-8 rounded-xl shadow-lg" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={staggerContainer}>
                        ...
                        <motion.div className="flex items-start space-x-4 mb-5" variants={fadeInUp}><FaPhoneAlt className="text-indigo-500 text-xl shrink-0 mt-1" /><div><h4 className="text-lg font-medium text-gray-900 dark:text-gray-50">Phone</h4><p className="text-gray-700 dark:text-gray-300">+8801577432917</p></div></motion.div>
                        <motion.div className="flex items-start space-x-4 mb-5" variants={fadeInUp}><FaMapMarkerAlt className="text-indigo-500 text-xl shrink-0 mt-1" /><div><h4 className="text-lg font-medium text-gray-900 dark:text-gray-50">Office Location</h4><p className="text-gray-700 dark:text-gray-300">Chattogram, Bangladesh (Headquarters)</p></div></motion.div>
