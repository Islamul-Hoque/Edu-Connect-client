            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    <motion.div className="bg-white p-8 rounded-xl shadow-lg" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={staggerContainer}>
                        ...
                        <motion.div className="flex items-start space-x-4 mb-5" variants={fadeInUp}><FaPhoneAlt className="text-indigo-500 text-xl shrink-0 mt-1" /><div><h4 className="text-lg font-medium text-gray-900">Phone/WhatsApp</h4><p className="text-gray-700">+8801761830425</p></div></motion.div>
